...
const updateAssinatura = async function (id, dadosAssinatura) {
    try {
        const updateData = {};
        if (dadosAssinatura.prazo !== undefined) updateData.prazo = dadosAssinatura.prazo;
        if (dadosAssinatura.is_cancelado !== undefined) updateData.is_cancelado = dadosAssinatura.is_cancelado;
        if (dadosAssinatura.dataCancelamento !== undefined) updateData.dataCancelamento = dadosAssinatura.dataCancelamento;
        if (dadosAssinatura.plano_id_cakto !== undefined) updateData.plano_id_cakto = dadosAssinatura.plano_id_cakto;
        if (dadosAssinatura.plano_name_cakto !== undefined) updateData.plano_name_cakto = dadosAssinatura.plano_name_cakto;
...
/**
 * SELECIONAR ASSINATURA POR USUÁRIO
 */
