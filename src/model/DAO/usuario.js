...
const updateUsuario = async function (id, dadosUsuario) {
    try {
        ...
        if (dadosUsuario.telefone !== undefined) updateData.telefone = dadosUsuario.telefone;
        if (dadosUsuario.email !== undefined) updateData.email = dadosUsuario.email;
        if (dadosUsuario.mensagens !== undefined) updateData.mensagens = dadosUsuario.mensagens;
        if (dadosUsuario.plano_id !== undefined) updateData.plano_id = dadosUsuario.plano_id;
        if (dadosUsuario.status_plano !== undefined) updateData.status_plano = dadosUsuario.status_plano;
        if (dadosUsuario.renda_mensal !== undefined) updateData.renda_mensal = dadosUsuario.renda_mensal;
        if (dadosUsuario.trial_end !== undefined) updateData.trial_end = dadosUsuario.trial_end;
